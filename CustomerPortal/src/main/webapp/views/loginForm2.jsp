...
body {
	background-image:
	 url("https://media.istockphoto.com/photos/finance-save-investment-start-picture-id1264288549?b=1&k=20&m=1264288549&s=170667a&w=0&h=_fzzDfl4k_-rLppl3DX65qdEl_j-EaJ5YxuoEuIxl8s=");
					...
					<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
						<div class="form-group">
							<label>Username </label> <input type="text" class="form-control"
								name="uname" id="uname" placeholder="Enter username">
						</div>
					</div>
				</div>
					...
					<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
						<div class="form-group">
							<label>Password </label> <input type="password" class="form-control"
								name="passwd" id="passwd" placeholder="Enter password">
						</div>
						<div class="alert alert-danger" role="alert">
							<span><i class="material-icons md-24"
								style="vertical-align: bottom !important;">error</i></span> Enter Valid
				...
				<div class="form-row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
							...
							<BR> <a href="/registrationForm"> New User? </a>
						</div>
					</div>
				</div>
			</form>
...
body {
	/* background-image:
		url("https://media.istockphoto.com/photos/portfolio-management-and-asset-allocation-concept-dollar-bag-on-picture-id1082036098?b=1&k=20&m=1082036098&s=170667a&w=0&h=A6h2XdkxMR-IaYTKhxJlaJ2KhDgq-isfCcPquLnTIGQ=");
	 */
	 background-image:
	 url("https://media.istockphoto.com/photos/finance-save-investment-start-picture-id1264288549?b=1&k=20&m=1264288549&s=170667a&w=0&h=_fzzDfl4k_-rLppl3DX65qdEl_j-EaJ5YxuoEuIxl8s=");
	background-attachment: fixed;
...
<body>
	...
	<BR>
	<div class="container-fluid rounded" id="bg-login">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-12 col-xs-12 col-lg-8" id="heading">
					<h2>Login</h2>
				</div>
			</div>
			<!-- <h4>${msg }</h4>	-->
			...
			<form action="/login" method="post">
				<div class="form-row">
					<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
						<div class="form-group">
							<label class="passwdLbl">Username </label> <input type="text" class="form-control"
								name="username" id="uname" placeholder="Enter username">
						</div>
					</div>
				</div>
				...
				<div class="form-row">
					<div class="col-md-6 col-sm-12 col-xs-12 col-lg-6">
						<div class="form-group">
							<label class="passwdLbl">Password </label> <input type="password"
								class="form-control" name="password" id="passwd"
				...
				<div class="form-row">
					<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
						<div class="form-group">
							<BR> <input class="submitButton rounded" type="submit" value="Login" />
...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="nav-link" href="/loginForm"><span
							class="material-icons" id="home"> home </span>&nbsp;Home <span
				...
				<div class="carousel-caption rounded">
					...
					<form action="/login" method="post">
						...
						<!-- <div class="alert alert-danger error" role="alert">
							<span><i class="material-icons md-24"
								 style="vertical-align: bottom !important; width: 10rem !important;">error</i></span>
							Enter Valid Credentials! Invalid username or password.
						</div> -->
						<div class="alert alert-danger error" role="alert">
									<span><i class="material-icons md-24"
										style="vertical-align: bottom !important;">error</i></span> Enter
									Valid Credentials! Invalid username or password.
								</div>
						<div class="form-row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								<div class="form-group">
	...
	<div class="container-fluid whyMutual">
