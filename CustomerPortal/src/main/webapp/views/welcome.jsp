...
<body>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="#yourAssets">Your
							assets </a></li>
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				...
				<div class="carousel-caption d-none d-md-block">
					<p class="welcomeMsg display-4">Hi ${username },</p>
					<p class="text-secondary">
						<BR> <span style="font-style: italic; font-size: large;">
							Before you start investing ask yourself these questions:</span> <span
							style="padding-left: 2rem;"> <BR> -> What are my
							goals? The reason behind making an investment. <BR> -> How
							long can I stay invested? The time frame I have in hand to earn
							positive returns. What is my risk tolerance? <BR> -> Till
							when can I afford to bear risk, if any?
						</span> <BR> <BR> <span
							style="font-style: italic; font-size: large;">
							Suggestions:</span> <BR> -> Read Terms and Conditions documents
						carefully before investing. <BR> -> Stay updated with recent
						business news + any updates in T&Cs. <BR> <BR> <span
							style="font-weight: bold;"> DON'T NEED TO CHECK STATUS OF
							YOUR INVESTMENTS DAILY. WE NOTIFY YOU. </span> <BR> <span
							style="font-weight: bold; font-size: xx-large; float: right; padding-right: 1.5rem;">
							:-) </span>
					</p>
				</div>
			</div>
			<div class="carousel-item">
				...
				<div class="carousel-caption captionSetter d-none d-md-block">
					<p class="welcomeMsg display-4">Hi ${username },</p>
					<p class="text-secondary">
						<BR> <span style="font-style: italic; font-size: large;">
							Before you start investing ask yourself these questions:</span> <span
	...
	<c:if test="${not empty msg }">
		<div class="toast fixed-bottom" data-autohide="true">
			<div class="toast-body">${msg }</div>
		</div>
	</c:if>
	<div id="yourAssets">
		<div class="container-fluid divide2">
			<p class="welcomeMsg display-4">Your assets, </p>
		</div>
		<div class="container-fluid " id="alignmentCondn">
			<%-- Your networth is ${networth } INR. <BR> <BR> --%>
			<div class="row">
				<div class="col-lg-4">
					<div class="card cardRowH1 scroll" id="card1">
						<div class="card-body">
							<p class="card-text">Your networth is</p>
							<h4 class="card-title">${networth }&nbsp;INR.</h4>
							<!-- 	
				...
				<div class="col-lg-4 ">
					<div class="card cardRowH scroll" id="card2">
						<div class="card-body">
							<h4 class="card-text">Shares you own</h4>
							<p class="card-text">
								<c:forEach items="${shareDetails}" var="eachShare">
									<BR>
									<div class="card innerCard">
										<div class="card-body">
											<h5 class="card-title">${eachShare.shareName}</h5>
											<h5 class="card-text">${eachShare.count}</h5>
										</div>
									</div>
									<%-- <h5></h5>
								<h6>${eachShare.count}</h6> --%>
								</c:forEach>
							</p>
				...
				<div class="col-lg-4">
					<div class="card cardRowH scroll" id="card3">
						<div class="card-body">
							<h4 class="card-text">Mutual Funds you own</h4>
							<p class="card-text">
								<c:forEach items="${mutualFundDetails}" var="eachmutualFund">
									<BR>
									<div class="card innerCard">
										<div class="card-body">
											<h5 class="card-title">${eachmutualFund.mutualFundName}</h5>
											<h5 class="card-text">${eachmutualFund.count}</h5>
										</div>
									</div>
									<%-- <h5></h5>
								<h6>${eachShare.count}</h6> --%>
	...
	<!-- <div class="backToTop">
		<a href=".carousel" class=""><i
			class="material-icons" class="icon-size">arrow_upward</i></a>
